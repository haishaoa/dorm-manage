...
<head>
    ...
    <link href="${pageContext.request.contextPath}/sandbox/DataTables/datatables.min.css" rel="stylesheet">
    <script src="${pageContext.request.contextPath}/sandbox/DataTables/datatables.min.js"></script>
...
<div class="container-fluid" style="padding-right: 0px;padding-left: 0px;">
    <div region="north" style="height: 100px;background-image: url('images/bg.jpg')">
        <div align="left" style="width: 80%;height:100px ;float: left;padding-top: 40px;padding-left: 30px;" ><font color="black" size="6" >宿舍管理系统</font></div>
        <div style="padding-top: 70px;padding-right: 20px;">当前用户：&nbsp;<font color="red" size="24px" >${sessionScope.username}</font></div>
    </div>
</div>
    ...
    <div class="row-fluid">
        <div class="span2 bs-docs-sidebar" >
            <ul class="nav nav-list bs-docs-sidenav">
                <li><a href="mainAdmin.jsp"><i class="icon-chevron-right"></i>首页</a></li>
                <li><a href="DormManagerServlet?action=list"><i class="icon-chevron-right"></i>宿舍管理员管理</a></li>
                <li><a href="StudentServlet?action=list"><i class="icon-chevron-right"></i>学生管理</a></li>
                <li><a href="DormBuildServlet?action=list"><i class="icon-chevron-right"></i>宿舍楼管理</a></li>
                <li><a href="RecordServlet?action=list"><i class="icon-chevron-right"></i>缺勤记录</a></li>
