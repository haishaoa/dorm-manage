...
<div class="container">
    <form name="myForm" class="form-signin" action="" method="post">
        ...
        <a href="regist.jsp">去注册</a><font id="error" color="red"
                                 style="margin: 0px 0px 0px 80px;font-size: 18px">${error }</font>

        <div style="margin: 0px 0px 0px 50px">
            <button class="btn btn-large btn-primary" type="button" onclick="loadCheck()">登录</button>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
