...
<div class="data_list">
		...
		<form name="myForm" class="form-search" method="post" action="DormManagerServlet?action=search">
				<button class="btn btn-success" type="button" style="margin-right: 50px;" onclick="javascript:window.location='DormManagerServlet?action=preSave'">添加</button>
			...
			<table class="table table-hover table-striped table-bordered">
				...
				<c:forEach  varStatus="i" var="dormManager" items="${dormManagerList }">
					<tr>
						...
						<td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='DormManagerServlet?action=managerchange&dormManagerId=${dormManager.dormManagerId }'">修改</button>&nbsp;
