...
<div class="data_list">
    ...
    <form action="StudentServlet?action=studentupdate" method="post" onsubmit="return checkForm()">
        <div class="data_form" >
            <%--<input type="hidden" id="studentId" name="studentId" value="${student.studentId }"/>--%>
            <table align="center">
                <tr>
                    <td><font color="red">*</font>学号</td>
                    <td><input readonly="readonly" style="margin-top:5px;height:30px;" type="text" id="studentId" name="studentId" value="${student.studentId }"/></td>
                ...
                <tr>
                    ...
                    <td>
                        <select id="sex" name="sex" style="width: 90px;" readonly="readonly">
                            <option value="${student.sex}" ${student.sex eq "男"?'selected':'' }>${student.sex}</option>
