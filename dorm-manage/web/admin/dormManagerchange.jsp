...
<div class="data_list">
    ...
    <form action="DormManagerServlet?action=update" method="post" onsubmit="return checkForm()">
        <div class="data_form" >
            <%--<input type="hidden" id="dormManagerId" name="dormManagerId" value="${dormManager.dormManagerId }"/>--%>
            <table align="center">
                <tr>
                    <td><font color="red">*</font>编号：</td>
                    <td><input readonly="readonly" type="text" id="dormManagerId"  name="dormManagerId" value="${dormManager.dormManagerId }"  style="margin-top:5px;height:30px;" /></td>
                </tr>
                <tr>
                    ...
                    <td>
                        <select id="dormBuildId" name="dormBuildId" style="width: 90px;">
                            <c:forEach var="dormBuild" items="${dormBuildList}">
                                ...
                                <c:if test="${dormBuild.dormBuildId==dormManager.dormBuildId}">
                                    <option selected="selected" id="dormBuildId1" value="${dormBuild.dormBuildId}" ${student.dormBuildId==dormBuild.dormBuildId?'selected':''}>${dormBuild.dormBuildId}</option>
                                </c:if>
                                <c:if test="${dormBuild.dormBuildId!=dormManager.dormBuildId}">
                ...
                <tr>
                    ...
                    <td><input readonly="readonly" type="text" id="name"  name="name" value="${dormManager.name }"  style="margin-top:5px;height:30px;" /></td>
                </tr>
                <tr>
                    <td><font color="red">*</font>性别：</td>
                    <td>
                        <select onfocus="this.defaultIndex=this.selectedIndex;" onchange="this.selectedIndex=this.defaultIndex;" id="sex" name="sex" style="width: 90px;">
