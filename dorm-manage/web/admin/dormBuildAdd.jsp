...
<div class="data_list">
    ...
    <form action="DormBuildServlet?action=saveadd" method="post" onsubmit="return checkForm()">
        <div class="data_form">
            <div style="margin-left: 545px">
                宿舍编号:<input style="margin-top:5px;height:30px;" type="text" id="dormBuildId" name="dormBuildId"/>
            </div>
            <table align="center">
                <tr>
