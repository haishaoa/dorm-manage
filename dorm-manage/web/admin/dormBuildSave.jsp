...
<div class="data_list">
    ...
    <form action="DormBuildServlet?action=save" method="post" onsubmit="return checkForm()">
        <div class="data_form">
            <div style="margin-left: 545px">
                宿舍编号:<input style="margin-top:5px;height:30px;" type="text" readonly="readonly" id="dormBuildId" name="dormBuildId"
                            value="${dormBuild.dormBuildId }"/>
            </div>
            <table align="center">
                <tr>
                    <td><font color="red">*</font>名称：</td>
                    <td><input type="text" id="dormBuildName" name="dormBuildName" value="${dormBuild.dormBuildName }"
