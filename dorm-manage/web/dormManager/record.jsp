...
<div class="data_list">
		...
		<form name="myForm" class="form-search" method="post" action="RecordServlet?action=search" style="padding-bottom: 0px">
				<button class="btn btn-success" type="button" style="margin-right: 50px;" onclick="javascript:window.location='RecordServlet?action=preSave'">添加</button>
				<span class="data_search">
					...
					<%--<span class="controls input-append date form_date" style="margin-right: 10px" data-date="" data-date-format="yyyy-mm-dd" data-link-format="yyyy-mm-dd">--%>
						...
						<%--<span class="add-on"><i class="icon-th"></i></span>--%>
               		<%--</span>--%>
					<span><font style="font-family: '黑体'; font-weight: bold; font-size: 20px" color="blue">${dormBuildName }&nbsp;&nbsp;</font></span>
			...
			<table class="table table-striped table-bordered table-hover datatable">
				...
				<c:forEach  varStatus="i" var="record" items="${recordList }">
					<tr>
						...
						<td>${record.detail }</td>
						<td>
							<button class="btn btn-mini btn-success" type="button" onclick="javascript:window.location='RecordServlet?action=preSave&recordId=${record.recordId }'">修改</button>
